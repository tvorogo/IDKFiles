# Installation Guide 
> [!Warning]
> This guide covers flashing ROMs using **Auto Installer by °⊥⋊ɹ∀°** ([Telegram](http://t.me/ArKT_7)). Improper use may **permanently brick your device**. Follow each step carefully and do not skip any instructions.
...
4. **Ensure device battery** is above 50% to prevent shutdown during flashing.  
...
# Step 1: Flash via Fastboot (PC Installation)
> [!Important]
...
<details>
    <summary> Flash via Recovery (TWRP) </summary> 
...
install_..._windows.bat     # first-time installation
